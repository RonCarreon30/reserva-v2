...
// Fetch reservations sorted by created_at and highlight declined reservations
...
// Fetch all reservations for the FullCalendar
$all_reservations_sql = "SELECT * FROM reservations WHERE user_id = $user_id ORDER BY created_at DESC";
